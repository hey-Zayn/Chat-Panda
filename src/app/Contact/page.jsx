          ...
          <div className="flex flex-col sm:flex-col md:flex-row xl:flex-row lg:flex-row 2xl:flex-row gap-[1%] justify-between">
            <div className="w-[55%] h-full mb-[10%] m-[4%]">
              <div className="flex gap-[8%]">
                <button className="p-5 py-3 text-lg md:text-sm font-semibold bg-[#E73C5F] text-gray-800 border-none rounded-md max-sm:hidden cursor-pointer">
                  Book a Demo
                </button>
                <button className="p-5 py-3 text-lg font-semibold md:text-sm text-white bg-[#212121] border border-white rounded-md max-sm:hidden cursor-pointer">
                  Careers
                </button>
              </div>
            ...
            <div className="w-full h-full m-[4%] my-0">
              <form className="flex flex-col gap-[15px]">
                ...
                <input
                  ...
                  className="p-5 w-[90%] sm:w-[90%] md:w-[100%] xl:w-[100%] lg:w-[100%] 2xl:w-[100%] text-lg font-semibold border border-gray-100 rounded-md focus:outline-none placeholder-[rgb(107,107,107)] placeholder:text-sm sm:placeholder:text-lg md:placeholder:text-lg xl:placeholder:text-lg lg:placeholder:text-lg 2xl:placeholder:text-lg"
                />

                <label htmlFor="companyName" className="text-xl sm:text-1xl 2xl:text-4xl md:text-1xl lg:text-2xl font-medium">
                  COMPANY NAME
                </label>
                <input
                  type="text"
                ...
                <input
                  ...
                  className="p-5 w-[90%] sm:w-[90%] md:w-[100%] xl:w-[100%] lg:w-[100%] 2xl:w-[100%] text-lg font-semibold border border-gray-100 rounded-md focus:outline-none placeholder-[rgb(107,107,107)] placeholder:text-sm sm:placeholder:text-lg md:placeholder:text-lg xl:placeholder:text-lg lg:placeholder:text-lg 2xl:placeholder:text-lg"
                />
                <label htmlFor="jobTitle" className="text-xl sm:text-1xl 2xl:text-4xl md:text-1xl lg:text-2xl font-medium">
                  JOB TITLE
                </label>
                <input
                  type="text"
                ...
                <select
                  id="source"
                  className="text-[rgb(114,114,114)] p-5 w-[90%] sm:w-[90%] md:w-[100%] xl:w-[100%] lg:w-[100%] 2xl:w-[100%] text-lg font-semibold border border-gray-100 rounded-md bg-[rgb(34,34,34)]"
                >
              ...
              <button className="p-8 py-3 text-lg font-semibold md:text-sm text-white bg-[#212121] border border-white rounded-md ml-[20%] mt-[8%] sm:mt-[4%] sm:ml-[0%] md:mt-[4%] md:ml-[0%] xl:mt-[4%] xl:ml-[0%] lg:mt-[4%] lg:ml-[0%] 2xl:ml-[0%] 2xl:mt-[4%] cursor-pointer">
                Get in Touch
              </button>
            </div>
          </div>
